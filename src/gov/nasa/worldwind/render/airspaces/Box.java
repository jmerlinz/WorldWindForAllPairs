...
public class Box extends AbstractAirspace
{
    ...
    public void makeSideGeometry(Terrain terrain, double[] altitudes, boolean[] terrainConformant, int lengthSegments,
        int widthSegments, BoxGeometry geom)
    {
    ...
    public void appendLocations(LatLon begin, LatLon middle, LatLon end, int numSegments, List<LatLon> result)
    {
